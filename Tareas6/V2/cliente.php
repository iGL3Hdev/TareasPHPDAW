<?php
    ...
    //Creamos el objeto del cliente SOAP con nuestro fichero
    $url = 'http://127.0.0.1/dwes/tarea6/servicio.php';
    $cliente = new SoapClient(null, array('location'=>$url, 'uri'=>''));

    //Llamamos a la función que obtinee el precio del artículo que le pasemos
    $pvp = $cliente->getPVP('PBELLI810323');
    echo "El precio del artículo <b>PBELLI810323</b> es: <br>" . $pvp . " &euro;</br><br /<hr />";

    //Llamamos a la función que obtiene el stock existente dle ar´ticulo y tienda pasados
    ...
    //Lamamos a la función que lista todos los artículos de la familia que le indiquemos
    $codigoF = $cliente->getProductosFamilia('ORDENA');
